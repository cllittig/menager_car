...
function headerSingle(origin: string | string[] | undefined): string | undefined {
    if (origin == null) {
        return undefined;
    }
...
export class AuthController {
    ...
    async forgotPassword(
        ...
        const fromBody = dto.clientOrigin?.trim();
        const fromOriginHeader = headerSingle(req.headers.origin);
        const redirectHint = fromBody || fromOriginHeader;
        return this.authService.requestPasswordReset(dto.email, redirectHint);
    }
